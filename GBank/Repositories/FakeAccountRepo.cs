...
namespace GBank.Repositories
{
    ...
    public class FakeAccountRepo : IAccountRepo
    {
        ...
        public List<Account> All()
        {
            ...
            items.Add(new Account() { AccountHolderId = Guid.Parse("a3539b0e-df06-4794-98ab-1c0fcbea8f65"), Currency = "EUR", Iban = "1", Usage = AccountUsage.Courant, Id = Guid.Parse("a3539b0e-df06-4794-98ab-1c0fcbea8f65") });
        ...
        { 
            return All().Where(x => x.AccountHolderId == customerId).ToList();
        }
    }
}
